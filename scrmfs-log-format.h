...
#ifndef __SCRMFS_LOG_FORMAT_H
#define __SCRMFS_LOG_FORMAT_H

#ifndef SCRMFS_CONFIG_H
    #error Must define SCRMFS_CONFIG_H
#endif

#include SCRMFS_CONFIG_H
#include <unistd.h>
#include <sys/types.h>
#include <stdint.h>
...
#define CP_EXE_LEN (CP_JOB_RECORD_SIZE - sizeof(struct scrmfs_job) - 1)

/* size (in bytes) of each file record */
#define CP_FILE_RECORD_SIZE (sizeof(struct scrmfs_file))
...
#define SCRMFS_JOB_METADATA_LEN 64 /* including null terminator! */
struct scrmfs_job
{
    ...
    int64_t nprocs;
    int64_t jobid;
    char metadata[SCRMFS_JOB_METADATA_LEN];
};
